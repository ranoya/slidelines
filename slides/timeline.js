...
estilo.setAttribute('href', "https://slidelines.vercel.app/slides/timeline.css" );
...
inserecoisacerta = function (oque, onde, tipo, fundo) {
    ...
    if (tipo == "imagem" || oque.match(/(\.png|\.jpg|\.svg)/i)) {
        ...
        xpto = `<iframe frameborder=0 style='width: 100vw;' src='../md/?embed=plain&file=${oque}'></iframe>`;
        document.getElementById(onde).innerHTML = xpto;

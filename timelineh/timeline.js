...
document.addEventListener("wheel", (event) => {
    ...
    if (typeof $_GET['allowverticalscroll'] != "undefined" && $_GET['allowverticalscroll'] != null && $_GET['allowverticalscroll'] != "") {
        ...
        if (!mudaviatempo) {
            ...
            document.getElementById("tempo").scrollLeft += event.deltaY / 20.05;
...
document.getElementById("frontslide").addEventListener("scroll", (event) => {
    ...
    if (!mudaviatempo) {
        ...
        document.getElementById("tempo").scrollLeft = (document.getElementById("frontslide").scrollLeft / 20.05);
...
document.getElementById("tempo").addEventListener("scroll", (event) => {
    ...
    if (mudaviatempo) {
        document.getElementById("frontslide").scrollLeft = document.getElementById("tempo").scrollLeft  * 20.05 ;

...
inserecoisacerta = function (oque, onde, tipo, fundo) {
    ...
    if (tipo == "imagem" || oque.match(/(\.png|\.jpg|\.svg)/i)) {
        ...
        xpto = `<iframe frameborder=0 style='width: 100vw;width: 100vw;top: 60px;position: relative;height: calc(100vh - 135px);' src='https://www.ranoya.com/aulas/tryit/markdown2/slim.html?embed=plain&file=${oque}'></iframe>`;
        document.getElementById(onde).innerHTML = xpto;
